INSERT IGNORE INTO Breed( Breed_Name)
Values( 'Labrador'), ('German Shepard'), ('Great Dane'), ('Pit Bull'), ('Jack Russel'), ('Pomeranian'), ('Beagle'), ('Africanis'), ('Unknown');

INSERT IGNORE INTO Shelter(Shelter_Name, Contact_Person, Email, Cellphone, Location)
VALUES('Maddies Rescue', 'Maddie', 'maddie.lymei@gmail.com', '0813728396', 'Centurion, Gauteng');

INSERT IGNORE INTO Size(Size_Name)
Values('X-Small'), ('Small'), ('Medium'), ('Large'), ('X-Large'), ('XX-Large');

INSERT IGNORE INTO DOG(Microchip_ID, Size_ID, Shelter_ID, Dog_Name, Dog_Description, Sex, Age, Special_Needs, Favourite_Treat, Favourite_Activity)
...
INSERT IGNORE INTO Dog_Breed(Breed_ID, Microchip_ID)
VALUES(4, 123456789123456), (8, 123456789123456), (3, 123556789123456);

INSERT IGNORE INTO Behaviour(Microchip_ID, Cat_Friendly, Dog_Friendly, Child_Friendly, Adult_Friendly, Shed)
